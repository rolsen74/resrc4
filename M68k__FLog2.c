...
int dst;
	...
	ms->ms_Str_Opcode = "FLog2.x";
	ms->ms_OpcodeSize = 4;

//	printf( "Unsupported 'FLog21' Opcode at %08x\n", ms->ms_MemoryAdr );
...
int len;
	...
	switch( src )
	{
		...
		case 6:
		{
			...
			ms->ms_Str_Opcode = "FLog2.b";
			break;
		}

		default:
		{
			printf( "Unsupported 'FLog22' Opcode (Size %d) at %08x\n", src, ms->ms_MemoryAdr );
