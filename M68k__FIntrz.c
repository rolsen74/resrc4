...
int dst;
	...
	ms->ms_Str_Opcode = "FIntrz.x";
	ms->ms_OpcodeSize = 4;

//	printf( "Unsupported 'FIntrz1' Opcode at %08x\n", ms->ms_MemoryAdr );
...
int len;
	...
	switch( src )
	{
		...
		case 6:
		{
			...
			ms->ms_Str_Opcode = "FIntrz.b";
			break;
		}

		default:
		{
			printf( "Unsupported 'FIntrz2' Opcode (Size %d) at %08x\n", src, ms->ms_MemoryAdr );
