...
static enum RS4FuncStat
ArgFunc_Sec_Split ( STR arg UNUSED )
{
	Sec_Split = TRUE;
...
static enum RS4FuncStat
ArgFunc_Sec_xDef ( STR arg UNUSED )
{
	Sec_xDef = TRUE;
...
static enum RS4FuncStat
ArgFunc_AutoYes ( STR arg UNUSED )
{
	enum RS4FuncStat fs;
...
static enum RS4FuncStat
ArgFunc_DebugInfo ( STR arg UNUSED )
{
	enum RS4FuncStat fs;
...
static enum RS4FuncStat
ArgFunc_Verbose0 ( STR arg UNUSED )
{
	enum RS4FuncStat fs;
...
static enum RS4FuncStat
ArgFunc_Verbose1 ( STR arg UNUSED )
{
	enum RS4FuncStat fs;
...
static enum RS4FuncStat
ArgFunc_Verbose2 ( STR arg UNUSED )
{
	enum RS4FuncStat fs;
...
static enum RS4FuncStat
ArgFunc_Verbose3 ( STR arg UNUSED )
{
	enum RS4FuncStat fs;
...
static enum RS4FuncStat
ArgFunc_Verbose4 ( STR arg UNUSED )
{
	enum RS4FuncStat fs;
...
static S32
_ParseList ( struct myArgs * args, S32 argc, STR argv[], S32 type )
{
	struct myArgs * arg;
	S32				error;
	S32				stat;
...
enum RS4FuncStat
RS4ParseArgs ( enum RS4ErrorCode * errcode, S32 argc, STR argv[] )
{
	...
	if ( Sec_Split )
	{
		...
		{
			if ( ( ! strcmp ( name, ".s" ) ) || ( ! strcmp ( name, ".asm" ) ) )
			{
				name[0] = 0;
			}
		}
