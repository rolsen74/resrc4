...
#define DATE			 "26.May.2026"
#define YEAR			 2026
#define VERSION			 2
#define REVISION		 19

#define MAX_REF_HASH	 29U // Prime Nr .. bigger value more memory pr. HunkNode
#define MAX_LABADR_HASH	 83U // Prime Nr .. Label Address Hash
#define MAX_LABNAME_HASH 47U // Prime Nr .. Label Name Hash
...
#define ERR_CHK( xxx )                                                                                                          \
	if ( ( fs = xxx ) != RS4FuncStat_Okay )                                                                                     \
	{                                                                                                                           \
		printf ( "%s:%04d: Func Error\n", __FILE__, __LINE__ );                                                                 \
		goto bailout;                                                                                                           \
	}
...
// -- m68k Effective Address

#if 0

#define EA_CHK( xxx )                                                                                                           \
	if ( ( ds = xxx ) != RS4DecodeStat_Okay )                                                                                   \
	{                                                                                                                           \
		printf ( "%s:%04d: EA Mode Error\n", __FILE__, __LINE__ );                                                              \
		goto bailout;                                                                                                           \
	}
...
enum RS4FuncStat
{
	RS4FuncStat_Okay,  // All okay
	RS4FuncStat_Error, // Fatal error
	RS4FuncStat_Last
};
...
struct _RS4FileHeader
{
	...
	S32				 rfh_SecFirst;
	S64				 rfh_StartAdr;
	RS4Label *		 rfh_Label_Adr_Hash[MAX_LABADR_HASH];
	RS4Label *		 rfh_Label_Name_Hash[MAX_LABNAME_HASH];
...
struct _RS4Label
{
	...
	RS4Label *			rl_Parent;
	RS4Label *			rl_Hash_Adr_Ptr;
	RS4Label *			rl_Hash_Name_Ptr;
...
S32 RS4BuildConfigName ( enum RS4ErrorCode * errcode );
S32 RS4CreateConfigFile ( RS4FileHeader * fh, enum RS4ErrorCode * errcode );
S32 RS4ParseFile ( RS4FileHeader * cfgfile, RS4FileHeader * exefile, enum RS4ErrorCode * errcode );

// -- Brance
enum RS4FuncStat RS4AddBrance_File ( enum RS4ErrorCode * errcode, RS4Brance ** rb, RS4FileHeader * fh, S64 addr );
...
// -- File Header
enum RS4FuncStat RS4LoadExe ( enum RS4ErrorCode * errcode, RS4FileHeader ** fh, STR filename );
enum RS4FuncStat RS4LoadFile ( enum RS4ErrorCode * errcode, RS4FileHeader ** fh, STR filename );
enum RS4FuncStat RS4FreeFile ( enum RS4ErrorCode * errcode, RS4FileHeader * fh );

// -- File Section
enum RS4FuncStat RS4AllocSection ( enum RS4ErrorCode * errcode, RS4FileSection ** sec_ptr, S32 secnr, S64 secsize );
...
// -- Label
enum RS4FuncStat RS4AddLabel_File ( enum RS4ErrorCode * errcode, RS4Label ** rl, RS4FileHeader * fh, S64 addr,
									enum RS4LabelType type, STR file );
enum RS4FuncStat RS4AddLabel_Sec ( enum RS4ErrorCode * errcode, RS4Label ** rl, RS4FileSection * sec, S64 addr,
								   enum RS4LabelType type );
enum RS4FuncStat RS4FreeLabel ( enum RS4ErrorCode * errcode, RS4Label * rl );
enum RS4FuncStat RS4_Find_LabelAdr ( enum RS4ErrorCode * errcode, RS4FileHeader * fh, RS4Label ** rl_ptr, S64 addr, STR file );
enum RS4FuncStat RS4_Find_LabelName ( enum RS4ErrorCode * errcode, RS4FileHeader * fh, RS4Label ** rl_ptr, STR find_name );
enum RS4FuncStat RS4_Add_LabelName ( enum RS4ErrorCode * errcode, RS4FileHeader * fh, RS4Label * rl, STR name );
...
U16				 Calc_CRC16 ( U8 * data, U64 len );
...
// -- Refs
enum RS4FuncStat RS4AddRef_Sec ( enum RS4ErrorCode * errcode, RS4Ref ** rr, RS4FileSection * sec, S64 addr );
enum RS4FuncStat RS4FreeRef ( enum RS4ErrorCode * errcode, RS4Ref * rr );
enum RS4FuncStat RS4FindRef_Sec ( enum RS4ErrorCode * errcode, RS4Ref ** rr, RS4FileSection * sec, S64 addr );
enum RS4FuncStat RS4FirstReloc_Sec ( enum RS4ErrorCode * errcode, RS4Ref ** rr, RS4FileSection * sec, S64 adr1, S64 adr2 );
...
enum RS4FuncStat RS4AddExtLabel ( enum RS4ErrorCode * errcode, RS4Label ** rl, RS4FileHeader * fh, S64 addr );
enum RS4JumpStat RS4JumpTable_Rel16 ( enum RS4ErrorCode * errcode, RS4FileHeader * fh, S64 tabel_adr, S64 relative_adr,
									  S32 entries );
...
extern S32						 Tabs_Opcode;
extern S32						 AutoAnser;
extern S32						 DebugInfo;
extern S32						 DoVerbose;
extern S32						 Sec_Split;
extern S32						 Sec_xDef;
// extern S32 Sec_xRef;
extern S32 Tabs_Label;
extern S32 Tabs_Arg;
