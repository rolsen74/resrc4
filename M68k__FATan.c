...
int len;
	...
	switch( src )
	{
		...
		case 6:
		{
			...
			ms->ms_Str_Opcode = "FATan.b";
			break;
		}

		default:
		{
			printf( "Unsupported 'FATan2' Opcode (Size %d) at %08x\n", src, ms->ms_MemoryAdr );
