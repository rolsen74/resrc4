...
int dst;
	...
	ms->ms_Str_Opcode = "FLognp1.x";
	ms->ms_OpcodeSize = 4;

//	printf( "Unsupported 'FLognp11' Opcode at %08x\n", ms->ms_MemoryAdr );
...
int len;
	...
	switch( src )
	{
		...
		case 6:
		{
			...
			ms->ms_Str_Opcode = "FLognp1.b";
			break;
		}

		default:
		{
			printf( "Unsupported 'FLognp12' Opcode (Size %d) at %08x\n", src, ms->ms_MemoryAdr );
