...
int dst;
	...
	ms->ms_Str_Opcode = "FEtoxm1.x";
	ms->ms_OpcodeSize = 4;

//	printf( "Unsupported 'FEtoxm11' Opcode at %08x\n", ms->ms_MemoryAdr );
...
int len;
	...
	switch( src )
	{
		...
		case 6:
		{
			...
			ms->ms_Str_Opcode = "FEtoxm1.b";
			break;
		}

		default:
		{
			printf( "Unsupported 'FEtoxm12' Opcode (Size %d) at %08x\n", src, ms->ms_MemoryAdr );
