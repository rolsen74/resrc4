...
int len;
	...
	switch( src )
	{
		...
		case 6:
		{
			...
			ms->ms_Str_Opcode = "FMul.b";
			break;
		}

		default:
		{
			printf( "Unsupported 'FMul2' Opcode (Size %d) at %08x\n", src, ms->ms_MemoryAdr );
