...
// printf( "Cmd_FSMOVE 2\n" );
	...
	switch( src )
	{
		...
		case 6:
		{
			...
			ms->ms_Str_Opcode = "FSMove.b";
			break;
		}

		default:
		{
			printf( "Unsupported 'FSMove2' Opcode (Size %d) at %08x\n", src, ms->ms_MemoryAdr );
