...
enum RS4DecodeStat M68kCmd_FLOGNP1( enum RS4ErrorCode *errcode, RS4Trace *rt )
{
...
int dst;
	...
	rt->rt_Container.Hunk.ms_Str_Opcode = "FLognp1.x";
...
enum RS4DecodeStat M68kCmd_FLOGNP12( enum RS4ErrorCode *errcode, RS4Trace *rt )
{
enum RS4DecodeStat ds;
enum RS4ErrorCode ec;
int emode;
...
int len;
	...
	switch( src )
	{
		case 0:
		{
			...
			rt->rt_Container.Hunk.ms_Str_Opcode = "FLognp1.l";
			break;
		}
		...
		case 1:
		{
			...
			rt->rt_Container.Hunk.ms_Str_Opcode = "FLognp1.s";
			break;
		}
		...
		case 3:
		{
			...
			rt->rt_Container.Hunk.ms_Str_Opcode = "FLognp1.p";
			break;
		}
		...
		case 4:
		{
			...
			rt->rt_Container.Hunk.ms_Str_Opcode = "FLognp1.w";
			break;
		}
		...
		case 5:
		{
			...
			rt->rt_Container.Hunk.ms_Str_Opcode = "FLognp1.d";
			break;
		}
		...
		case 6:
		{
			...
			rt->rt_Container.Hunk.ms_Str_Opcode = "FLognp1.b";
			break;
		}

		default:
		{
			printf( "Unsupported 'FLognp12' Opcode (Size %d) at $%08" PRIx64 "\n", src, rt->rt_CurMemAdr );
