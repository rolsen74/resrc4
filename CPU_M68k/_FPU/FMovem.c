...
RegMask ( enum RS4ErrorCode * errcode, RS4Trace * rt, S32 reverse )
{
...
enum RS4DecodeStat
M68kCmd_FMOVEM_2_0 ( enum RS4ErrorCode * errcode, RS4Trace * rt, S32 emode, S32 ereg, S32 dr )
{
	enum RS4DecodeStat ds;
	enum RS4ErrorCode  ec;
...
enum RS4DecodeStat
M68kCmd_FMOVEM_2_2 ( enum RS4ErrorCode * errcode, RS4Trace * rt, S32 emode, S32 ereg, S32 dr )
{
	enum RS4DecodeStat ds;
	enum RS4ErrorCode  ec;
...
enum RS4DecodeStat
M68kCmd_FMOVEM ( enum RS4ErrorCode * errcode, RS4Trace * rt )
{
	enum RS4DecodeStat ds;
	enum RS4ErrorCode  ec;
	S32				   emode;
...
enum RS4DecodeStat
M68kCmd_FMOVEM2 ( enum RS4ErrorCode * errcode, RS4Trace * rt )
{
	enum RS4DecodeStat ds;
	enum RS4ErrorCode  ec;
	S32				   emode;
