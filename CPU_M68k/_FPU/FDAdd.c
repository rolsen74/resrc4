...
enum RS4DecodeStat M68kCmd_FDADD( enum RS4ErrorCode *errcode, RS4Trace *rt )
{
...
S32 dst;
	...
	rt->rt_Container.Hunk.ms_Str_Opcode = "FDAdd.x";
...
enum RS4DecodeStat M68kCmd_FDADD2( enum RS4ErrorCode *errcode, RS4Trace *rt )
{
enum RS4DecodeStat ds;
enum RS4ErrorCode ec;
S32 emode;
...
S32 len;
	...
	switch( src )
	{
		case 0:
		{
			...
			rt->rt_Container.Hunk.ms_Str_Opcode = "FAdd.l";
			break;
		}
		...
		case 1:
		{
			...
			rt->rt_Container.Hunk.ms_Str_Opcode = "FAdd.s";
			break;
		}
		...
		case 2:
		{
			...
			rt->rt_Container.Hunk.ms_Str_Opcode = "FAdd.x";
			break;
		}
		...
		case 3:
		{
			...
			rt->rt_Container.Hunk.ms_Str_Opcode = "FAdd.p";
			break;
		}
		...
		case 4:
		{
			...
			rt->rt_Container.Hunk.ms_Str_Opcode = "FAdd.w";
			break;
		}
		...
		case 5:
		{
			...
			rt->rt_Container.Hunk.ms_Str_Opcode = "FAdd.d";
			break;
		}
		...
		case 6:
		{
			...
			rt->rt_Container.Hunk.ms_Str_Opcode = "FAdd.b";
			break;
		}

		default:
		{
			printf( "Unsupported 'FAdd2' Opcode (Size %d) at $%08" PRIx64 "\n", src, rt->rt_CurMemAdr );
