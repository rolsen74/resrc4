...
enum RS4DecodeStat M68kCmd_FATAN( enum RS4ErrorCode *errcode, RS4Trace *rt )
{
...
int dst;
	...
	rt->rt_Container.Hunk.ms_Str_Opcode = "FATan.x";
...
enum RS4DecodeStat M68kCmd_FATAN2( enum RS4ErrorCode *errcode, RS4Trace *rt )
{
enum RS4DecodeStat ds;
enum RS4ErrorCode ec;
int emode;
...
int len;
	...
	switch( src )
	{
		case 0:
		{
			...
			rt->rt_Container.Hunk.ms_Str_Opcode = "FATan.l";
			break;
		}
		...
		case 1:
		{
			...
			rt->rt_Container.Hunk.ms_Str_Opcode = "FATan.s";
			break;
		}
		...
		case 3:
		{
			...
			rt->rt_Container.Hunk.ms_Str_Opcode = "FATan.p";
			break;
		}
		...
		case 4:
		{
			...
			rt->rt_Container.Hunk.ms_Str_Opcode = "FATan.w";
			break;
		}
		...
		case 5:
		{
			...
			rt->rt_Container.Hunk.ms_Str_Opcode = "FATan.d";
			break;
		}
		...
		case 6:
		{
			...
			rt->rt_Container.Hunk.ms_Str_Opcode = "FATan.b";
			break;
		}

		default:
		{
			printf( "Unsupported 'FATan2' Opcode (Size %d) at $%08" PRIx64 "\n", src, rt->rt_CurMemAdr );
