...
enum RS4DecodeStat M68kCmd_FDSUB( enum RS4ErrorCode *errcode, RS4Trace *rt )
{
...
S32 dst;
	...
	rt->rt_Container.Hunk.ms_Str_Opcode = "FDSub.x";
...
enum RS4DecodeStat M68kCmd_FDSUB2( enum RS4ErrorCode *errcode, RS4Trace *rt )
{
enum RS4DecodeStat ds;
enum RS4ErrorCode ec;
S32 emode;
...
S32 len;
	...
	switch( src )
	{
		case 0:
		{
			...
			rt->rt_Container.Hunk.ms_Str_Opcode = "FDSub.l";
			break;
		}
		...
		case 1:
		{
			...
			rt->rt_Container.Hunk.ms_Str_Opcode = "FDSub.s";
			break;
		}
		...
		case 3:
		{
			...
			rt->rt_Container.Hunk.ms_Str_Opcode = "FDSub.p";
			break;
		}
		...
		case 4:
		{
			...
			rt->rt_Container.Hunk.ms_Str_Opcode = "FDSub.w";
			break;
		}
		...
		case 5:
		{
			...
			rt->rt_Container.Hunk.ms_Str_Opcode = "FDSub.d";
			break;
		}
		...
		case 6:
		{
			...
			rt->rt_Container.Hunk.ms_Str_Opcode = "FDSub.b";
			break;
		}

		default:
		{
			printf( "Unsupported 'FDSub2' Opcode (Size %d) at $%08" PRIx64 "\n", src, rt->rt_CurMemAdr );
