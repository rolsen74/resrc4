...
enum RS4DecodeStat M68kCmd_FINTRZ( enum RS4ErrorCode *errcode, RS4Trace *rt )
{
...
S32 dst;
	...
	rt->rt_Container.Hunk.ms_Str_Opcode = "FIntrz.x";
...
enum RS4DecodeStat M68kCmd_FINTRZ2( enum RS4ErrorCode *errcode, RS4Trace *rt )
{
enum RS4DecodeStat ds;
enum RS4ErrorCode ec;
S32 emode;
...
S32 len;
	...
	switch( src )
	{
		case 0:
		{
			...
			rt->rt_Container.Hunk.ms_Str_Opcode = "FIntrz.l";
			break;
		}
		...
		case 1:
		{
			...
			rt->rt_Container.Hunk.ms_Str_Opcode = "FIntrz.s";
			break;
		}
		...
		case 3:
		{
			...
			rt->rt_Container.Hunk.ms_Str_Opcode = "FIntrz.p";
			break;
		}
		...
		case 4:
		{
			...
			rt->rt_Container.Hunk.ms_Str_Opcode = "FIntrz.w";
			break;
		}
		...
		case 5:
		{
			...
			rt->rt_Container.Hunk.ms_Str_Opcode = "FIntrz.d";
			break;
		}
		...
		case 6:
		{
			...
			rt->rt_Container.Hunk.ms_Str_Opcode = "FIntrz.b";
			break;
		}

		default:
		{
			printf( "Unsupported 'FIntrz2' Opcode (Size %d) at $%08" PRIx64 "\n", src, rt->rt_CurMemAdr );
