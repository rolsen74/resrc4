...
enum RS4DecodeStat M68kCmd_FTWOTOX( enum RS4ErrorCode *errcode, RS4Trace *rt )
{
...
int dst;
	...
	rt->rt_Container.Hunk.ms_Str_Opcode = "FTwotox.x";
...
enum RS4DecodeStat M68kCmd_FTWOTOX2( enum RS4ErrorCode *errcode, RS4Trace *rt )
{
enum RS4DecodeStat ds;
enum RS4ErrorCode ec;
int emode;
...
int len;
	...
	switch( src )
	{
		case 0:
		{
			...
			rt->rt_Container.Hunk.ms_Str_Opcode = "FTwotox.l";
			break;
		}
		...
		case 1:
		{
			...
			rt->rt_Container.Hunk.ms_Str_Opcode = "FTwotox.s";
			break;
		}
		...
		case 3:
		{
			...
			rt->rt_Container.Hunk.ms_Str_Opcode = "FTwotox.p";
			break;
		}
		...
		case 4:
		{
			...
			rt->rt_Container.Hunk.ms_Str_Opcode = "FTwotox.w";
			break;
		}
		...
		case 5:
		{
			...
			rt->rt_Container.Hunk.ms_Str_Opcode = "FTwotox.d";
			break;
		}
		...
		case 6:
		{
			...
			rt->rt_Container.Hunk.ms_Str_Opcode = "FTwotox.b";
			break;
		}

		default:
		{
			printf( "Unsupported 'FTwotox2' Opcode (Size %d) at $%08" PRIx64 "\n", src, rt->rt_CurMemAdr );
