...
enum RS4DecodeStat M68kCmd_FNEG( enum RS4ErrorCode *errcode, RS4Trace *rt )
{
...
S32 dst;
	...
	rt->rt_Container.Hunk.ms_Str_Opcode = "FNeg.x";
...
enum RS4DecodeStat M68kCmd_FNEG2( enum RS4ErrorCode *errcode, RS4Trace *rt )
{
enum RS4DecodeStat ds;
enum RS4ErrorCode ec;
S32 emode;
...
S32 len;
	...
	switch( src )
	{
		case 0:
		{
			...
			rt->rt_Container.Hunk.ms_Str_Opcode = "FNeg.l";
			break;
		}
		...
		case 1:
		{
			...
			rt->rt_Container.Hunk.ms_Str_Opcode = "FNeg.s";
			break;
		}
		...
		case 3:
		{
			...
			rt->rt_Container.Hunk.ms_Str_Opcode = "FNeg.p";
			break;
		}
		...
		case 4:
		{
			...
			rt->rt_Container.Hunk.ms_Str_Opcode = "FNeg.w";
			break;
		}
		...
		case 5:
		{
			...
			rt->rt_Container.Hunk.ms_Str_Opcode = "FNeg.d";
			break;
		}
		...
		case 6:
		{
			...
			rt->rt_Container.Hunk.ms_Str_Opcode = "FNeg.b";
			break;
		}

		default:
		{
			printf( "Unsupported 'FNeg2' Opcode (Size %d) at $%08" PRIx64 "\n", src, rt->rt_CurMemAdr );
