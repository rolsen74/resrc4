...
enum RS4DecodeStat M68kCmd_FSMOVE( enum RS4ErrorCode *errcode, RS4Trace *rt )
{
...
enum RS4DecodeStat M68kCmd_FSMOVE2( enum RS4ErrorCode *errcode, RS4Trace *rt )
{
enum RS4DecodeStat ds;
enum RS4ErrorCode ec;
S32 emode;
...
// printf( "M68kCmd_FSMOVE 2\n" );
	...
	switch( src )
	{
		case 0:
		{
			...
			rt->rt_Container.Hunk.ms_Str_Opcode = "FSMove.l";
			break;
		}
		...
		case 1:
		{
			...
			rt->rt_Container.Hunk.ms_Str_Opcode = "FSMove.s";
			break;
		}
		...
		case 3:
		{
			...
			rt->rt_Container.Hunk.ms_Str_Opcode = "FSMove.p";
			break;
		}
		...
		case 4:
		{
			...
			rt->rt_Container.Hunk.ms_Str_Opcode = "FSMove.w";
			break;
		}
		...
		case 5:
		{
			...
			rt->rt_Container.Hunk.ms_Str_Opcode = "FSMove.d";
			break;
		}
		...
		case 6:
		{
			...
			rt->rt_Container.Hunk.ms_Str_Opcode = "FSMove.b";
			break;
		}

		default:
		{
			printf( "Unsupported 'FSMove2' Opcode (Size %d) at $%08" PRIx64 "\n", src, rt->rt_CurMemAdr );
