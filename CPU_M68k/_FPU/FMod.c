...
enum RS4DecodeStat M68kCmd_FMOD( enum RS4ErrorCode *errcode, RS4Trace *rt )
{
...
S32 dst;
	...
	rt->rt_Container.Hunk.ms_Str_Opcode = "FMod.x";
...
enum RS4DecodeStat M68kCmd_FMOD2( enum RS4ErrorCode *errcode, RS4Trace *rt )
{
enum RS4DecodeStat ds;
enum RS4ErrorCode ec;
S32 emode;
...
S32 len;
	...
	switch( src )
	{
		case 0:
		{
			...
			rt->rt_Container.Hunk.ms_Str_Opcode = "FMod.l";
			break;
		}
		...
		case 1:
		{
			...
			rt->rt_Container.Hunk.ms_Str_Opcode = "FMod.s";
			break;
		}
		...
		case 3:
		{
			...
			rt->rt_Container.Hunk.ms_Str_Opcode = "FMod.p";
			break;
		}
		...
		case 4:
		{
			...
			rt->rt_Container.Hunk.ms_Str_Opcode = "FMod.w";
			break;
		}
		...
		case 5:
		{
			...
			rt->rt_Container.Hunk.ms_Str_Opcode = "FMod.d";
			break;
		}
		...
		case 6:
		{
			...
			rt->rt_Container.Hunk.ms_Str_Opcode = "FMod.b";
			break;
		}

		default:
		{
			printf( "Unsupported 'FMod2' Opcode (Size %d) at $%08" PRIx64 "\n", src, rt->rt_CurMemAdr );
