...
static const struct CmdStruct m68kCmds_1110[] = {
	...
	{ M68kCmd_BFTST, 0xffc0f000, 0xe8c00000 },	// BFTST	1110 1000 11xx xxxx 0000 xxxx xxxxx xxxx
	{ M68kCmd_BFEXTU, 0xffc08000, 0xe9c00000 }, // BFEXTU	1110 1001 11xx xxxx 0xxx xxxx xxxxx xxxx
	{ M68kCmd_BFCHG, 0xffc0f000, 0xeac00000 },	// BFCHG	1110 1010 11xx xxxx 0000 xxxx xxxxx xxxx
	{ M68kCmd_BFEXTS, 0xffc08000, 0xebc00000 }, // BFEXTS	1110 1011 11xx xxxx 0xxx xxxx xxxxx xxxx
	{ M68kCmd_BFCLR, 0xffc0f000, 0xecc00000 },	// BFCLR	1110 1100 11xx xxxx 0000 xxxx xxxxx xxxx
	{ M68kCmd_BFFFO, 0xffc08000, 0xedc00000 },	// BFFFO	1110 1101 11xx xxxx 0xxx xxxx xxxxx xxxx
	{ M68kCmd_BFSET, 0xffc0f000, 0xeec00000 },	// BFSET	1110 1110 11xx xxxx 0000 xxxx xxxxx xxxx
	{ M68kCmd_BFINS, 0xffc08000, 0xefc00000 },	// BFINS	1110 1111 11xx xxxx 0xxx xxxx xxxxx xxxx
...
static const struct CmdStruct *
Find_Opcode ( enum RS4ErrorCode * errcode, RS4Trace * rt )
{
...
void
M68k_Set_Cur_to_Unknown ( RS4Trace * rt )
{
...
enum RS4DecodeStat
M68k_Decoder ( enum RS4ErrorCode * errcode, RS4Trace * rt )
{
	...
	if ( ( ! rt->rt_File ) || ( ! rt->rt_Section ) || ( ! rt->rt_CurMemAdr ) || ( ! rt->rt_CurMemBuf ) || ( ! rt->rt_CurMemType )
		 || ( ! rt->rt_Container.Hunk.ms_Buf_Argument ) || ( rt->rt_Pass == RS4TracePass_Unset ) )
	{
	...
	{
		printf ( "%s:%04d: Decode : Odd Address : $%" PRIx64 "\n", __FILE__, __LINE__, rt->rt_CurMemAdr );
	}
	...
	if ( DoVerbose > 3 )
	{
		...
		if ( rt->rt_Container.Hunk.ms_Str_Opcode )
		{
			for ( ii = 0; ii < 12; ii++ )
			{
