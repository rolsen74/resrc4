...
enum RS4DecodeStat M68kCmd_CHK2( enum RS4ErrorCode *errcode, RS4Trace *rt )
{
...
uint32_t size;
	...
	switch( size )
	{
		case 0:
		{
			rt->rt_Container.Hunk.ms_Str_Opcode = "Chk2.b";
		...
		case 1:
		{
			rt->rt_Container.Hunk.ms_Str_Opcode = "Chk2.w";
		...
		case 2:
		{
			rt->rt_Container.Hunk.ms_Str_Opcode = "Chk2.l";
