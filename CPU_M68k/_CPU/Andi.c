...
enum RS4DecodeStat
M68kCmd_ANDI ( enum RS4ErrorCode * errcode, RS4Trace * rt )
{
...
enum RS4DecodeStat
M68kCmd_ANDI2 ( enum RS4ErrorCode * errcode, RS4Trace * rt )
{
	enum RS4DecodeStat ds;
	enum RS4ErrorCode  ec;
	U8				   val;
...
enum RS4DecodeStat
M68kCmd_ANDI3 ( enum RS4ErrorCode * errcode, RS4Trace * rt )
{
	enum RS4DecodeStat ds;
	enum RS4ErrorCode  ec;
	U16				   val;
