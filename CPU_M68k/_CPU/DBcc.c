...
enum RS4DecodeStat
M68kCmd_DBcc ( enum RS4ErrorCode * errcode, RS4Trace * rt )
{
	...
	static CSTR dbcc_RegNames[16] = { "DBt.w",	"DBf.w",  "DBhi.w", "DBls.w", "DBcc.w", "DBcs.w", "DBne.w", "DBeq.w",
									  "DBvc.w", "DBvs.w", "DBpl.w", "DBmi.w", "DBge.w", "DBlt.w", "DBgt.w", "DBle.w" };
