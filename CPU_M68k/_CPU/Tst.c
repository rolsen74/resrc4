...
enum RS4DecodeStat M68kCmd_TST( enum RS4ErrorCode *errcode, RS4Trace *rt )
{
...
uint32_t size;
	...
	switch( size )
	{
		case 0:
		{
			rt->rt_Container.Hunk.ms_Str_Opcode = "Tst.b";
		...
		case 1:
		{
			rt->rt_Container.Hunk.ms_Str_Opcode = "Tst.w";
		...
		case 2:
		{
			rt->rt_Container.Hunk.ms_Str_Opcode = "Tst.l";
