...
enum RS4DecodeStat M68kCmd_LSR( enum RS4ErrorCode *errcode, RS4Trace *rt )
{
enum RS4DecodeStat ds;
enum RS4ErrorCode ec;
int size;
	...
	switch( size )
	{
		case 0:
		{
			rt->rt_Container.Hunk.ms_Str_Opcode = "Lsr.b";
			break;
		}

		case 1:
		{
			rt->rt_Container.Hunk.ms_Str_Opcode = "Lsr.w";
			break;
		}

    	case 2:
		{
			rt->rt_Container.Hunk.ms_Str_Opcode = "Lsr.l";
			break;
		}
...
enum RS4DecodeStat M68kCmd_LSR2( enum RS4ErrorCode *errcode, RS4Trace *rt )
{
enum RS4DecodeStat ds;
enum RS4ErrorCode ec;
