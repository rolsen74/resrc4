...
enum RS4DecodeStat M68kCmd_ADDA( enum RS4ErrorCode *errcode, RS4Trace *rt )
{
...
S32 opmode;
	...
	switch( opmode )
	{
		...
		case 3:
		{
			rt->rt_Container.Hunk.ms_Str_Opcode = ( ShortOpcodes ) ? "Add.w" : "Adda.w";
		...
		case 7:
		{
			rt->rt_Container.Hunk.ms_Str_Opcode = ( ShortOpcodes ) ? "Add.l" : "Adda.l";
		...
		default:
		{
			printf( "Unsupported 'Adda' Opcode (Mode: %d)\n", opmode );
