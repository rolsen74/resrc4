...
enum RS4DecodeStat M68kCmd_ROXL( enum RS4ErrorCode *errcode, RS4Trace *rt )
{
enum RS4DecodeStat ds;
enum RS4ErrorCode ec;
int size;
	...
	switch( size )
	{
		case 0:
		{
			rt->rt_Container.Hunk.ms_Str_Opcode = "Roxl.b";
			break;
		}

		case 1:
		{
			rt->rt_Container.Hunk.ms_Str_Opcode = "Roxl.w";
			break;
		}

		case 2:
    	{
			rt->rt_Container.Hunk.ms_Str_Opcode = "Roxl.l";
			break;
		}
...
enum RS4DecodeStat M68kCmd_ROXL2( enum RS4ErrorCode *errcode, RS4Trace *rt )
{
enum RS4DecodeStat ds;
enum RS4ErrorCode ec;
