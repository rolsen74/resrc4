...
enum RS4DecodeStat
M68kCmd_DIV ( enum RS4ErrorCode * errcode, RS4Trace * rt )
{
...
enum RS4DecodeStat
M68kCmd_DIVS_L ( enum RS4ErrorCode * errcode, RS4Trace * rt )
{
	enum RS4DecodeStat ds;
	enum RS4ErrorCode  ec;
	U32				   pos;
...
enum RS4DecodeStat
M68kCmd_DIVU_L ( enum RS4ErrorCode * errcode, RS4Trace * rt )
{
	enum RS4DecodeStat ds;
	enum RS4ErrorCode  ec;
	U32				   pos;
