...
enum RS4DecodeStat M68kCmd_BCHG( enum RS4ErrorCode *errcode, RS4Trace *rt )
{
enum RS4DecodeStat ds;
enum RS4ErrorCode ec;
S32 nr;

	rt->rt_Container.Hunk.ms_Str_Opcode = "BChg";
...
enum RS4DecodeStat M68kCmd_BCHG2( enum RS4ErrorCode *errcode, RS4Trace *rt )
{
enum RS4DecodeStat ds;
enum RS4ErrorCode ec;
S32 reg;
