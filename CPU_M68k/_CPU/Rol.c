...
enum RS4DecodeStat M68kCmd_ROL( enum RS4ErrorCode *errcode, RS4Trace *rt )
{
enum RS4DecodeStat ds;
enum RS4ErrorCode ec;
int size;
	...
	switch( size )
	{
		case 0:
		{
			rt->rt_Container.Hunk.ms_Str_Opcode = "Rol.b";
			break;
		}

		case 1:
		{
			rt->rt_Container.Hunk.ms_Str_Opcode = "Rol.w";
			break;
		}

		case 2:
    	{
			rt->rt_Container.Hunk.ms_Str_Opcode = "Rol.l";
			break;
		}

		default:
		{
			printf( "Unsupported 'Rol' Opcode (Mode: %d)\n", size );
...
enum RS4DecodeStat M68kCmd_ROL2( enum RS4ErrorCode *errcode, RS4Trace *rt )
{
enum RS4DecodeStat ds;
enum RS4ErrorCode ec;
