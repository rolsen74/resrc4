...
enum RS4DecodeStat M68kCmd_SUB( enum RS4ErrorCode *errcode, RS4Trace *rt )
{
...
S32 opmode;
	...
	switch( opmode )
	{
		case 0:
		{
			rt->rt_Container.Hunk.ms_Str_Opcode = "Sub.b";
		...
		case 1:
		{
			rt->rt_Container.Hunk.ms_Str_Opcode = "Sub.w";
		...
		case 2:
		{
			rt->rt_Container.Hunk.ms_Str_Opcode = "Sub.l";
