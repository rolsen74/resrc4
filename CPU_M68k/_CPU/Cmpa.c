...
enum RS4DecodeStat M68kCmd_CMPA( enum RS4ErrorCode *errcode, RS4Trace *rt )
{
...
S32 opmode;
	...
	switch( opmode )
	{
		...
		case 3:
		{
			rt->rt_Container.Hunk.ms_Str_Opcode = ( ShortOpcodes ) ? "Cmp.w" : "Cmpa.w";
		...
		case 7:
		{
			rt->rt_Container.Hunk.ms_Str_Opcode = ( ShortOpcodes ) ? "Cmp.l" : "Cmpa.l";
