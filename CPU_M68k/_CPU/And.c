...
enum RS4DecodeStat
M68kCmd_AND ( enum RS4ErrorCode * errcode, RS4Trace * rt )
{
	...
	switch ( opmode )
	{
		case 0:
		{
			rt->rt_Container.Hunk.ms_Str_Opcode = "And.b";
		...
		case 1:
		{
			rt->rt_Container.Hunk.ms_Str_Opcode = "And.w";
		...
		case 2:
		{
			rt->rt_Container.Hunk.ms_Str_Opcode = "And.l";
		...
		default:
		{
			printf ( "Unsupported 'And' Opcode (Mode: %d)\n", opmode );
