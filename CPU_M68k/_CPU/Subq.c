...
enum RS4DecodeStat M68kCmd_SUBQ( enum RS4ErrorCode *errcode, RS4Trace *rt )
{
...
int size;
	...
	switch( size )
	{
		case 0:
		{
			rt->rt_Container.Hunk.ms_Str_Opcode = "Subq.b";
		...
		case 1:
		{
			rt->rt_Container.Hunk.ms_Str_Opcode = "Subq.w";
		...
		case 2:
		{
			rt->rt_Container.Hunk.ms_Str_Opcode = "Subq.l";
