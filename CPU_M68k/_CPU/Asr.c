...
enum RS4DecodeStat M68kCmd_ASR( enum RS4ErrorCode *errcode, RS4Trace *rt )
{
enum RS4DecodeStat ds;
enum RS4ErrorCode ec;
int size;
	...
	switch( size )
	{
		case 0:
		{
			rt->rt_Container.Hunk.ms_Str_Opcode = "Asr.b";
			break;
		}

		case 1:
		{
			rt->rt_Container.Hunk.ms_Str_Opcode = "Asr.w";
			break;
		}

		case 2:
    	{
			rt->rt_Container.Hunk.ms_Str_Opcode = "Asr.l";
			break;
		}

		default:
		{
			printf( "Unsupported 'Asr' Opcode (Mode: %d)\n", size );
...
enum RS4DecodeStat M68kCmd_ASR2( enum RS4ErrorCode *errcode, RS4Trace *rt )
{
enum RS4DecodeStat ds;
enum RS4ErrorCode ec;
