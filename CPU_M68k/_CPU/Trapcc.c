...
enum RS4DecodeStat
M68kCmd_TRAPcc ( enum RS4ErrorCode * errcode, RS4Trace * rt )
{
	...
	switch ( size )
	{
		case 2: // Trapcc.w
		{
			...
			static CSTR trapcc_RegNames[16]
				= { "Trapt.w",	"Trapf.w",	"Traphi.w", "Trapls.w", "Trapcc.w", "Trapcs.w", "Trapne.w", "Trapeq.w",
					"Trapvc.w", "Trapvs.w", "Trappl.w", "Trapmi.w", "Trapge.w", "Traplt.w", "Trapgt.w", "Traple.w" };
		...
		case 3: // Trapcc.l
		{
			...
			static CSTR trapcc_RegNames[16]
				= { "Trapt.l",	"Trapf.l",	"Traphi.l", "Trapls.l", "Trapcc.l", "Trapcs.l", "Trapne.l", "Trapeq.l",
					"Trapvc.l", "Trapvs.l", "Trappl.l", "Trapmi.l", "Trapge.l", "Traplt.l", "Trapgt.l", "Traple.l" };
		...
		case 4: // Trapcc
		{
			static CSTR trapcc_RegNames[16] = { "Trapt",  "Trapf",	"Traphi", "Trapls", "Trapcc", "Trapcs", "Trapne", "Trapeq",
