...
enum RS4DecodeStat M68kCmd_BFCHG ( enum RS4ErrorCode *, RS4Trace * );
enum RS4DecodeStat M68kCmd_BFCLR ( enum RS4ErrorCode *, RS4Trace * );
enum RS4DecodeStat M68kCmd_BFEXTS ( enum RS4ErrorCode *, RS4Trace * );
enum RS4DecodeStat M68kCmd_BFEXTU ( enum RS4ErrorCode *, RS4Trace * );
enum RS4DecodeStat M68kCmd_BFFFO ( enum RS4ErrorCode *, RS4Trace * );
enum RS4DecodeStat M68kCmd_BFINS ( enum RS4ErrorCode *, RS4Trace * );
enum RS4DecodeStat M68kCmd_BFTST ( enum RS4ErrorCode *, RS4Trace * );
enum RS4DecodeStat M68kCmd_BFSET ( enum RS4ErrorCode *, RS4Trace * );
...
enum RS4DecodeStat MODE_00 ( enum RS4ErrorCode *, RS4Trace *, STR );
enum RS4DecodeStat MODE_10 ( enum RS4ErrorCode *, RS4Trace *, STR );
enum RS4DecodeStat MODE_20 ( enum RS4ErrorCode *, RS4Trace *, STR );
enum RS4DecodeStat MODE_30 ( enum RS4ErrorCode *, RS4Trace *, STR );
