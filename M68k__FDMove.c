...
// printf( "Cmd_FDMOVE 2\n" );
	...
	switch( src )
	{
		...
		case 6:
		{
			...
			ms->ms_Str_Opcode = "FDMove.b";
			break;
		}

		default:
		{
			printf( "Unsupported 'FDMove2' Opcode (Size %d) at %08x\n", src, ms->ms_MemoryAdr );
