...
static struct myLibType1 myLibs[] = { myentry1 ( AmigaguideBase, "Amigaguide" ),
...
STR
AmigaOS3_FindLibFunc ( enum RS4ErrorCode * errcode, RS4Trace * rt, S16 offset, STR file UNUSED )
{
...
S32
AmigaOS3_SaveLibFunc ( PTR in, STR buffer )
{
	AOS3_LVOStruct * liblvos;
	S32				 error;
	S32				 pos1;
