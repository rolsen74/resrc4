...
static AOS3_RegStruct _String_A0[] = { AOS3_REG_String ( M68KREGT_A0 ), AOS3_REG_EndMarker () };

static AOS3_RegStruct _String_A1[] = { AOS3_REG_String ( M68KREGT_A1 ), AOS3_REG_EndMarker () };

static AOS3_RegStruct _MsgPort_A1[] = { AOS3_REG_Struct ( M68KREGT_A1, RS4StructID_MsgPort ), AOS3_REG_EndMarker () };

static AOS3_RegStruct _Code_A5[] = { AOS3_REG_Code ( M68KREGT_A5 ), AOS3_REG_EndMarker () };

// --

static AOS3_RegStruct _Interrupt_A1[] = { AOS3_REG_Struct ( M68KREGT_A1, RS4StructID_Interrupt ), AOS3_REG_EndMarker () };

static AOS3_RegStruct _StackSwap_A0[] = { AOS3_REG_Struct ( M68KREGT_A0, RS4StructID_StackSwap ), AOS3_REG_EndMarker () };
...
AOS3_LVOStruct AOS3_ExecBase[] = { AOS3_LVO_Regs ( -30, Supervisor ),
