...
static AOS3_RegStruct _BitMap_A0[] = { AOS3_REG_Struct ( M68KREGT_A0, RS4StructID_BitMap ), AOS3_REG_EndMarker () };

static AOS3_RegStruct _RastPort_A1[] = { AOS3_REG_Struct ( M68KREGT_A1, RS4StructID_RastPort ), AOS3_REG_EndMarker () };

static AOS3_RegStruct _TextAttr_A0[] = { AOS3_REG_Struct ( M68KREGT_A0, RS4StructID_TextAttr ), AOS3_REG_EndMarker () };

static AOS3_RegStruct _TextFont_A0[] = { AOS3_REG_Struct ( M68KREGT_A0, RS4StructID_TextFont ), AOS3_REG_EndMarker () };

static AOS3_RegStruct _TextFont_A1[] = { AOS3_REG_Struct ( M68KREGT_A1, RS4StructID_TextFont ), AOS3_REG_EndMarker () };

// --
// Double input

static AOS3_RegStruct _BitMap_Bitmap_A0_A1[] = { AOS3_REG_Struct ( M68KREGT_A0, RS4StructID_BitMap ),
												 AOS3_REG_Struct ( M68KREGT_A1, RS4StructID_BitMap ), AOS3_REG_EndMarker () };

static AOS3_RegStruct _BitMap_RastPort_A0_A1[]
	= { AOS3_REG_Struct ( M68KREGT_A0, RS4StructID_BitMap ), AOS3_REG_Struct ( M68KREGT_A1, RS4StructID_RastPort ),
		AOS3_REG_EndMarker () };

static AOS3_RegStruct _TextFont_RastPort_A0_A1[]
	= { AOS3_REG_Struct ( M68KREGT_A0, RS4StructID_TextFont ), AOS3_REG_Struct ( M68KREGT_A1, RS4StructID_RastPort ),
		AOS3_REG_EndMarker () };

static AOS3_RegStruct _String_RastPort_A0_A1[]
	= { AOS3_REG_String ( M68KREGT_A0 ), AOS3_REG_Struct ( M68KREGT_A1, RS4StructID_RastPort ), AOS3_REG_EndMarker () };
...
AOS3_LVOStruct AOS3_GraphicsBase[] = { AOS3_LVO_Regs ( -30, BltBitMap ),
