...
static AOS3_RegStruct _String_D1[] = { AOS3_REG_String ( M68KREGT_D1 ), AOS3_REG_EndMarker () };

// Default D2 = Label String
static AOS3_RegStruct _String_D2[] = { AOS3_REG_String ( M68KREGT_D2 ), AOS3_REG_EndMarker () };

// Default D3 = Label String
static AOS3_RegStruct _String_D3[] = { AOS3_REG_String ( M68KREGT_D3 ), AOS3_REG_EndMarker () };

// Default D1 + D2 = Label String
static AOS3_RegStruct _String_D1D2[]
	= { AOS3_REG_String ( M68KREGT_D1 ), AOS3_REG_String ( M68KREGT_D2 ), AOS3_REG_EndMarker () };
...
static AOS3_RegStruct AOS3_ReadLink_Regs[] = {
	...
	AOS3_REG_String ( M68KREGT_D3 ), AOS3_REG_String ( M68KREGT_D4 ), AOS3_REG_EndMarker ()
};
...
AOS3_LVOStruct AOS3_DosBase[] = { AOS3_LVO_Regs ( -30, Open ),
