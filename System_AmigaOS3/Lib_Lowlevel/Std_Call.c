...
AOS3_LVOStruct AOS3_LowlevelBase[]
	= { AOS3_LVO_Name ( -30, ReadJoyPort ), AOS3_LVO_Name ( -36, GetLanguageSelection ),
		//	AOS3_LVO_Name( -42, lowlevelPrivate1 ),
		AOS3_LVO_Name ( -48, GetKey ), AOS3_LVO_Name ( -54, QueryKeys ), AOS3_LVO_Name ( -60, AddKBInt ),
		AOS3_LVO_Name ( -66, RemKBInt ), AOS3_LVO_Name ( -72, SystemControlA ), AOS3_LVO_Name ( -78, AddTimerInt ),
		AOS3_LVO_Name ( -84, RemTimerInt ), AOS3_LVO_Name ( -90, StopTimerInt ), AOS3_LVO_Name ( -96, StartTimerInt ),
		AOS3_LVO_Name ( -102, ElapsedTime ), AOS3_LVO_Name ( -108, AddVBlankInt ), AOS3_LVO_Name ( -114, RemVBlankInt ),
