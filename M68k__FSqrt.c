...
//	printf( "Unsupported 'FSqrt2' Opcode at %08x\n", ms->ms_MemoryAdr );
	...
	switch( src )
	{
		...
		case 6:
		{
			...
			ms->ms_Str_Opcode = "FSqrt.b";
			break;
		}

		default:
		{
			printf( "Unsupported 'FSqrt2' Opcode (Size %d) at %08x\n", src, ms->ms_MemoryAdr );
